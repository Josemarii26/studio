...
>(
  (
    ...
    if (isMobile) {
      return (
        <Sheet open={effectiveOpen} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
    ...
    return (
      ...
      >
        <div
          className={cn(
            "fixed top-16 h-[calc(100vh-4rem)] z-10 hidden w-[400px] xl:w-[450px] transition-[left,right,width] ease-linear md:flex",
            side === "left"
              ? "left-0"
              : "right-0",
            className
