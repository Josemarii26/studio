...
const steps = [
  ...
  },
  {
    ...
    title: "The AI Chat",
    description: "This is where the magic happens. Instead of manually entering every item, just tell the AI what you ate throughout the day. IMPORTANT: The idea is to do this once at the end of the day. You can only successfully log your meals once per day, so give it a full summary!",
    image: "https://picsum.photos/600/400",
